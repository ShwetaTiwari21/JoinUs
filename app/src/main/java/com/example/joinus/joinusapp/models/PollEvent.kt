...
data class PollEvent(var poll_title:String?, var poll_id:String?,var category: String?,var description:String?,
                     ...
                     var url:String?,var min_participants:Number?, var max_participants:Number?){

    constructor(poll_id: String):this(null,poll_id,null,null,null,null,null,null,null,null)
}