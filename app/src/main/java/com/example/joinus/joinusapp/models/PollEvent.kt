...
data class PollEvent(var poll_title:String?, var poll_id:String?,var category: String?,var description:String?,
    ...
    constructor(poll_id: String):this(null,poll_id,null,null,null,null,null,null,null,null,null,null,false)

    constructor(poll_title: String,poll_id: String,category: String,description: String,time: String,date: String,
                url: String,min_participants: String,max_participants: String,is_interested: Boolean):this(poll_title,poll_id,category,description,
            null,null,time,date,null,url,min_participants,max_participants,false)
}